...
You are the analyst on the subscription team. Boxcar is carrying too
many plans. The have six plans which means six menus, six pack lines, six promo calendars, 
and Dana (the owner) has decided **one plan gets retired at the start of Q4.** Your job
...
| `plan_summary.py` | The Python script the last analyst ran each quarter. Run it with `uv run python plan_summary.py`. |
...
| `plan_memo.md` | The template for what you hand in. Fill it in and upload it to Gradescope link on Brightspace. |
...
machine, and never push. 

Nothing is handed in through GitHub. The one thing you submit for this module is
**`plan_memo.md`**, filled in and uploaded to **Gradescope** link given on Brightspace. Due before 11:00am on Monday, Aug 31st.
